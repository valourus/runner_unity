...
public partial class InputEntity {
    ...
    public Sources.Components.CollisionComponent collision { get { return (Sources.Components.CollisionComponent)GetComponent(InputComponentsLookup.Collision); } }
    public bool hasCollision { get { return HasComponent(InputComponentsLookup.Collision); } }

    public void AddCollision(UnityEngine.GameObject newSelf, UnityEngine.GameObject newOther) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<Sources.Components.CollisionComponent>(index);
        component.self = newSelf;
        component.other = newOther;
        AddComponent(index, component);
    }

    public void ReplaceCollision(UnityEngine.GameObject newSelf, UnityEngine.GameObject newOther) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<Sources.Components.CollisionComponent>(index);
        component.self = newSelf;
        component.other = newOther;
