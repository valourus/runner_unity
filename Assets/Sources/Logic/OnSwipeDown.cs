...
namespace Sources.Logic {
	public class OnSwipeDown : ReactiveSystem<InputEntity> {
		private GameContext game { get; set; }

		public OnSwipeDown(Contexts context) : base(context.input) {
			game = context.game;
		}
		
		public OnSwipeDown(ICollector<InputEntity> collector) : base(collector) { }
